...
public class PurchaseLives implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] strings) {
        if (s.equalsIgnoreCase("purchaselives")) {
            if (!commandSender.hasPermission("hardcorelives.purchaselives")) {
            ...
            if (strings.length < 2) {
                ...
                commandSender.sendMessage(ChatColor.WHITE + "/purchaselives <player> <amount>");
                return false;
            } else {
                ...
                if (target != null && target.isOnline()) {
                    ...
                    commandSender.sendMessage(ChatColor.GREEN + target.getName() + " has purchased " + strings[1] + " lives!");
                    target.sendMessage(ChatColor.GREEN + "Thank you for buying " + strings[1] + " lives!");
                    ...
                    commandSender.sendMessage(ChatColor.GREEN + name + " has purchased " + strings[1] + " lives!");
                    return true;
                }
            }
            return true;
